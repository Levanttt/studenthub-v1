...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
    ...
    <div class="mb-6 sm:mb-8">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-4">
            ...
            <div class="flex flex-row gap-2 w-full sm:w-auto">
                <a href="index.php" 
                class="flex-1 bg-gray-100 text-gray-700 px-4 sm:px-6 py-2.5 sm:py-3 rounded-xl font-semibold hover:bg-gray-200 transition-colors duration-300 border border-gray-200 flex items-center justify-center gap-2 text-sm sm:text-base">
                    <span class="iconify" data-icon="mdi:home" data-width="16"></span>
                    <span class="hidden sm:inline">Kembali Ke Pencarian</span>
                    <span class="sm:hidden">Pencarian</span>
                </a>
                <a href="student-profile.php?id=<?php echo $student_id; ?>" 
                class="flex-1 bg-[#E0F7FF] text-[#2A8FA9] px-4 sm:px-6 py-2.5 sm:py-3 rounded-xl font-semibold hover:bg-[#51A3B9] hover:text-white transition-colors duration-300 border border-[#51A3B9] border-opacity-30 flex items-center justify-center gap-2 text-sm sm:text-base">
            ...
            <div class="flex flex-wrap items-center justify-between gap-4">
                <div class="flex items-center gap-3 sm:gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-[#409BB2] text-sm sm:text-base">Total project yang telah dikerjakan</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <?php if ($total_projects == 0): ?>
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sm:p-12 text-center">
            <div class="max-w-md mx-auto">
                ...
                <h3 class="text-xl sm:text-2xl font-bold text-[#2A8FA9] mb-2 sm:mb-3">Belum Ada Project</h3>
                <p class="text-gray-600 mb-2 text-sm sm:text-base">Mahasiswa ini belum menambahkan project ke portofolio mereka.</p>
                <p class="text-gray-500 text-xs sm:text-sm mb-6 sm:mb-8">Silakan kembali untuk melihat talenta lainnya</p>
                <div class="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
                    <a href="student-profile.php?id=<?php echo $student_id; ?>" 
                        class="bg-[#2A8FA9] text-white px-6 sm:px-8 py-3 sm:py-4 rounded-xl font-bold hover:bg-[#409BB2] transition-all duration-300 flex items-center justify-center gap-2 shadow-lg text-sm sm:text-base">
                        <span class="iconify" data-icon="mdi:account-circle" data-width="18"></span>
                        Kembali ke Profil
                    </a>
                    <a href="index.php" 
                        class="bg-gray-100 text-gray-700 px-6 sm:px-8 py-3 sm:py-4 rounded-xl font-semibold hover:bg-gray-200 transition-colors duration-300 border border-gray-200 flex items-center justify-center gap-2 text-sm sm:text-base">
                        <span class="iconify" data-icon="mdi:search" data-width="18"></span>
                        Cari Talenta Lain
                    </a>
                </div>
            </div>
    ...
    <?php else: ?>
        ...
        <div class="sm:hidden mb-6 bg-[#E0F7FF] rounded-xl p-4 text-center border border-[#51A3B9] border-opacity-30">
            <span class="text-[#2A8FA9] font-bold text-sm">Halaman <?php echo $current_page; ?> dari <?php echo $total_pages; ?></span>
        </div>
        <?php endif; ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-200 hover:shadow-lg transition-all duration-300 group overflow-hidden project-card flex flex-col h-[420px] sm:h-[480px] relative">
                <a href="project-detail.php?id=<?php echo $project['id']; ?>&student_id=<?php echo $student_id; ?>" class="block cursor-pointer">
                    ...
                    <div class="p-4 sm:p-5">
                        <div class="flex justify-between items-start mb-2">
                            ...
                            <span class="text-gray-500 text-xs sm:text-sm font-medium bg-gray-100 px-2 py-1 rounded whitespace-nowrap">
                        ...
                        <div class="flex flex-wrap gap-1 mb-3">
                            <?php 
                            $displaySkills = array_slice($all_skills, 0, 4);
                            $totalSkills = count($all_skills);
                            $remaining = $totalSkills - 4;
                            ...
                            ?>
                                <span class="<?php echo $color_class; ?> px-2 py-1 rounded-lg text-xs font-medium">
                        ...
                        <!-- Project Description -->
                        <div class="min-h-[50px] sm:min-h-[60px] mb-3 sm:mb-4"> 
                ...
                <!-- ACTION LINKS -->
                <div class="absolute bottom-0 left-0 right-0 bg-white border-t border-gray-200 px-4 sm:px-5 py-3 sm:py-4 flex-shrink-0">
                    <div class="flex items-center justify-between">
                        <a href="project-detail.php?id=<?php echo $project['id']; ?>&student_id=<?php echo $student_id; ?>" 
                        class="text-[#2A8FA9] hover:text-[#51A3B9] font-semibold flex items-center gap-2 group/link text-sm sm:text-base">
                            View Details
                        ...
                        <div class="flex items-center gap-2 sm:gap-3 text-gray-400">
                            ...
                            target="_blank"
                            class="hover:text-gray-700 transition-colors p-1.5 sm:p-2 bg-white rounded-lg border border-gray-200 shadow-sm"
                            ...
                            target="_blank"
                            class="hover:text-[#2A8FA9] transition-colors p-1.5 sm:p-2 bg-white rounded-lg border border-gray-200 shadow-sm"
                            title="Link Terkait">
                                <span class="iconify" data-icon="mdi:web" data-width="14"></span>
                            </a>
                            <?php endif; ?>
                            ...
                            target="_blank"
                            class="hover:text-purple-600 transition-colors p-1.5 sm:p-2 bg-white rounded-lg border border-gray-200 shadow-sm"
                            title="Figma Design">
        ...
        <?php if ($total_pages > 1): ?>
        <div class="flex justify-center items-center space-x-3 sm:space-x-4 mt-6 sm:mt-8 mb-6 sm:mb-8">
            <!-- Previous Button -->
            <a href="?id=<?php echo $student_id; ?>&page=<?php echo max(1, $current_page - 1); ?>" 
            class="flex items-center gap-2 px-4 sm:px-6 py-2.5 sm:py-3 bg-white border border-gray-300 rounded-xl font-semibold text-gray-700 hover:bg-gray-50 transition-colors duration-300 text-sm sm:text-base <?php echo $current_page == 1 ? 'opacity-50 cursor-not-allowed' : ''; ?>">
                <span class="iconify" data-icon="mdi:chevron-left" data-width="16"></span>
                <span class="hidden sm:inline">Sebelumnya</span>
            </a>

            <!-- Page Info (Hidden on desktop since it's in header) -->
            <div class="hidden sm:flex items-center gap-2 bg-[#E0F7FF] rounded-xl px-4 sm:px-6 py-2.5 sm:py-3">
            ...
            class="flex items-center gap-2 px-4 sm:px-6 py-2.5 sm:py-3 bg-white border border-gray-300 rounded-xl font-semibold text-gray-700 hover:bg-gray-50 transition-colors duration-300 text-sm sm:text-base <?php echo $current_page == $total_pages ? 'opacity-50 cursor-not-allowed' : ''; ?>">
