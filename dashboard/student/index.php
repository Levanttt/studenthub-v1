...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div class="bg-white rounded-2xl p-6 text-center shadow-sm border border-gray-100 hover:shadow-md transition-all duration-300 hover-lift">
            ...
            <h3 class="text-[#2A8FA9] font-bold text-2xl mb-2"><?php echo $project_count; ?></h3>
        ...
        <div class="bg-white rounded-2xl p-6 text-center shadow-sm border border-gray-100 hover:shadow-md transition-all duration-300 hover-lift">
            ...
            <h3 class="text-[#2A8FA9] font-bold text-2xl mb-2"><?php echo $total_likes; ?></h3>
    ...
    <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
        ...
        <?php if ($project_count == 0): ?>
            ...
            <div class="text-center py-12">
                ...
                <h3 class="text-[#2A8FA9] font-bold text-xl mb-2">Belum Ada Proyek</h3>
                <p class="text-gray-600 mb-6">Mulai bangun portofolio kamu dengan menambahkan proyek pertama</p>
                <a href="add-project.php" class="bg-[#51A3B9] text-white px-8 py-3 rounded-xl font-bold hover:bg-[#409BB2] transition-colors duration-300 inline-flex items-center gap-2">
